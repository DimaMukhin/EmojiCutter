...
serverErrorHelper.getErrorMessage = (errorCode) => {
    ...
    switch(errorCode) {
        case 1:
            errorMessage = 'Invalid emoji name (emoji name must contain only letters numbers and dashes)';
            break;
        case 2:
            errorMessage = 'Could not read file';
            break;
        case 4:
            errorMessage = 'file format not supported (supported formats PNG/JPEG/BMP)';
            break;
        case 10:
